        ...
        <form method="POST" action="{{ route('products.update', $product) }}" class="space-y-4">
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <div>
                    ...
                    <input type="text" name="id_produk" value="{{ old('id_produk', $product->id_produk) }}" required
                ...
                <div>
                    ...
                    <input type="number" name="harga_offline" value="{{ old('harga_offline', $product->harga_offline) }}" min="0" required
                           class="w-full px-4 py-2.5 border border-gray-300 rounded-xl text-sm focus:outline-none focus:ring-2 focus:ring-blue-500">
                </div>
                <div>
                    <label class="block text-sm font-medium text-gray-700 mb-1">Harga Online (Rp) <span class="text-red-500">*</span></label>
                    <input type="number" name="harga_online" value="{{ old('harga_online', $product->harga_online) }}" min="0" required
                           class="w-full px-4 py-2.5 border border-gray-300 rounded-xl text-sm focus:outline-none focus:ring-2 focus:ring-blue-500">
                </div>
                <div>
                    <label class="block text-sm font-medium text-gray-700 mb-1">Jumlah Stok <span class="text-red-500">*</span></label>
                    <input type="number" name="jumlah_stok" value="{{ old('jumlah_stok', $product->jumlah_stok) }}" min="0" required
                           class="w-full px-4 py-2.5 border border-gray-300 rounded-xl text-sm focus:outline-none focus:ring-2 focus:ring-blue-500">
                </div>
