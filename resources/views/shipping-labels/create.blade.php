@extends('layouts.app')
@section('title', 'Upload Resi')
@section('page-title', 'Upload Resi PDF')
...
<div class="max-w-2xl">
    <div class="bg-white rounded-xl border border-gray-200 shadow-sm p-6">
        ...
        <form method="POST" action="{{ route('shipping-labels.store') }}" enctype="multipart/form-data" class="space-y-4">
            @csrf
            <div>
