...
<div class="max-w-2xl">
    <div class="bg-white rounded-xl border border-gray-200 shadow-sm p-6">
        <h2 class="text-base font-bold text-gray-800 mb-5">Form Edit Produk</h2>
        ...
        <form method="POST" action="<?php echo e(route('products.update', $product)); ?>" class="space-y-4">
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <div>
                    ...
                    <input type="text" name="id_produk" value="<?php echo e(old('id_produk', $product->id_produk)); ?>" required
                ...
                <div>
                    ...
                    <input type="text" name="nama_produk" value="<?php echo e(old('nama_produk', $product->{'nama_produk'})); ?>" required
                        class="w-full px-4 py-2.5 border border-gray-300 rounded-xl text-sm focus:outline-none focus:ring-2 focus:ring-blue-500">
                </div>
                <div>
                    <label class="block text-sm font-medium text-gray-700 mb-1">Harga Offline (Rp) <span class="text-red-500">*</span></label>
                    <input type="number" name="harga_offline" value="<?php echo e(old('harga_offline', $product->harga_offline)); ?>" min="0" required
                           class="w-full px-4 py-2.5 border border-gray-300 rounded-xl text-sm focus:outline-none focus:ring-2 focus:ring-blue-500">
                </div>
                <div>
                    <label class="block text-sm font-medium text-gray-700 mb-1">Harga Online (Rp) <span class="text-red-500">*</span></label>
                    <input type="number" name="harga_online" value="<?php echo e(old('harga_online', $product->harga_online)); ?>" min="0" required
                           class="w-full px-4 py-2.5 border border-gray-300 rounded-xl text-sm focus:outline-none focus:ring-2 focus:ring-blue-500">
                </div>
                <div>
                    <label class="block text-sm font-medium text-gray-700 mb-1">Jumlah Stok <span class="text-red-500">*</span></label>
                    <input type="number" name="jumlah_stok" value="<?php echo e(old('jumlah_stok', $product->jumlah_stok)); ?>" min="0" required
                           class="w-full px-4 py-2.5 border border-gray-300 rounded-xl text-sm focus:outline-none focus:ring-2 focus:ring-blue-500">
                </div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\sistem_stok_toko\resources\views/products/edit.blade.php ENDPATH**/ ?>